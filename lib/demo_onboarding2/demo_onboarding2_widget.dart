...
class DemoOnboarding2Widget extends StatefulWidget {
  const DemoOnboarding2Widget({Key key}) : super(key: key);

  @override
  _DemoOnboarding2WidgetState createState() => _DemoOnboarding2WidgetState();
}

class _DemoOnboarding2WidgetState extends State<DemoOnboarding2Widget> {
